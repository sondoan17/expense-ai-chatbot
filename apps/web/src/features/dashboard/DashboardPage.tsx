    ...
    <div className="flex flex-col gap-4 h-full overflow-y-auto">
      <header className="rounded-2xl border border-slate-700/40 bg-slate-900/60 backdrop-blur-xl h-fit sticky top-0 z-10">
        <div className="flex items-center justify-between px-5 py-4">
          <div>
            <h1 className="m-0 text-xl font-semibold tracking-tight">Bảng điều khiển</h1>
      ...
      <div className="p-4">
        ...
        {activeTab === 'budgets' && (
          <BudgetsTab budgets={budgets} loading={budgetsLoading} formatCurrency={formatCurrency} />
        )}
