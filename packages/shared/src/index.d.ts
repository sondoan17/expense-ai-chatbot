...
export declare const CANONICAL_CATEGORIES: readonly [
  'Ăn uống',
  'Di chuyển',
  'Nhà ở',
  'Mua sắm',
...
export declare function resolveCategoryName(
  value?: string | null,
...
export declare const AgentPayloadSchema: z.ZodObject<
  {
    ...
    recurring_txn_type: z.ZodOptional<
      z.ZodEnum<{
        EXPENSE: 'EXPENSE';
        INCOME: 'INCOME';
      }>
